<?php
/*
 * Template Name: Register to Vote (es)
 */
?>
<?php get_header(); ?>
            ...
            <div class="container">
                ...
                <div class="vote-registration__content">
                    ...
                    <div class="content__form">
                        ...
                        <iframe src="https://register.rockthevote.com/registrants/new?partner=101&amp;locale=es<?php echo !empty($_GET['source']) ? '&amp;source=' . htmlentities($_GET['source']) : ''; ?>" width="100%" height="100%" frameborder="0" onload="document.getElementById('spinner').style.display='none';"></iframe>
                    </div>
                </div>
            </div> <!-- .container -->
