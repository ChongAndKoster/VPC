<?php
/*
 * Template Name: Custom Tool - Lookup
 */
?>
<?php 
    get_header();
                                ...
                                if( state_abbrev && lat && lng ){
                                    ...
                                    if( state_abbrev == 'MI'){
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            dataType: "jsonp",
                                            url: "https://www.googleapis.com/civicinfo/v2/voterinfo?key=<?php echo $google_api_key; ?>&electionId=8085",
                                            data: formData,
                                                    ...
                                                    */
                                                    ...
                                                    if(onlyEarlyVote.length > 0){
                                                        ...
                                                        if(ballotTrackCheck){
                                                            ...
                                                            $('#result-location').append('<p class="ballot-track content-row--bright-green p-4">We do not have any information for this location at this time. Please try again later or visit your Secretary of State website for more information. [1]</p>');
                                                        }
                                                    }
                                                    ...
                                                    if(ballotTrackCheck){
                                                        ...
                                                        $('#result-location').append('<p class="ballot-track content-row--bright-green p-4">We do not have any information for this location at this time. Please try again later or visit your Secretary of State website for more information. [2]</p>');
                                                    }
                                                }
