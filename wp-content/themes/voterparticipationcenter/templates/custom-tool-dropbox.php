<?php
/*
 * Template Name: Custom Tool - Dropbox
 */
?>
<?php 
    get_header();
    ...
    if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <script>
            ...
            var ballotTrack = [];
            ballotTrack['AK'] = 'This tool does not have voting data for Alaska, please <a target="_blank" href="https://myvoterinformation.alaska.gov/">visit the Secretary of State website</a> for information on how to vote.';
            ...
            ballotTrack['ID'] = '';
            ballotTrack['IL'] = '';
            ballotTrack['IA'] = 'This tool does not have voting data for Iowa, please <a target="_blank" href="https://sos.iowa.gov/elections/voterinformation/index.html">visit the Secretary of State website</a> for information on how to vote.';
            ...
            ballotTrack['NJ'] = '';
            ballotTrack['NM'] = '';
            ballotTrack['NY'] = 'This tool does not have voting data for New York, please <a target="_blank" href="https://www.elections.ny.gov/">visit the Secretary of State website</a> for information on how to vote.';
            ballotTrack['NC'] = '';
            ballotTrack['ND'] = '';
            ballotTrack['OH'] = '';
            ballotTrack['OK'] = '';
            ballotTrack['OR'] = 'This tool does not have voting data for Oregon please <a target="_blank" href="https://sos.oregon.gov/voting-elections/Pages/default.aspx">visit the Secretary of State website</a> for information on how to vote.';
            ...
            ballotTrack['RI'] = '';
            ballotTrack['SD'] = '';
            ballotTrack['UT'] = 'This tool does not have voting data for Utah, please <a target="_blank" href="https://vote.utah.gov/">visit the Secretary of State website</a> for information on how to vote.';
            ballotTrack['VT'] = '';
            ballotTrack['VA'] = '';
            ballotTrack['WA'] = 'This tool does not have voting data for Washington, please <a target="_blank" href="https://www.sos.wa.gov/elections/">visit the Secretary of State website</a> for information on how to vote.';
            ...
            // No early voting
            var noEarlyVoting = [];
            noEarlyVoting['AL'] = 'Alabama does not have ballot drop boxes. Please <a target="_blank" href="https://www.sos.alabama.gov/alabama-votes">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['CT'] = 'Connecticut does not have ballot drop boxes. Please <a target="_blank" href="https://portal.ct.gov/SOTS/Common-Elements/V5-Template---Redesign/Elections--Voting--Home-Page">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['DE'] = 'Delaware does not have ballot drop boxes. Please <a target="_blank" href="https://elections.delaware.gov/">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['IN'] = 'Indiana does not have ballot drop boxes. Please <a target="_blank" href="https://www.in.gov/sos/elections/">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['KY'] = 'Kentucky does not have ballot drop boxes. Please <a target="_blank" href="https://elect.ky.gov/Pages/default.aspx">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['LA'] = 'Louisiana does not have ballot drop boxes. Please <a target="_blank" href="https://www.sos.la.gov/ElectionsAndVoting/Pages/default.aspx">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['MA'] = 'Massachusetts does not have ballot drop boxes. Please <a target="_blank" href="https://www.sec.state.ma.us/ele/">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['MS'] = 'Mississippi does not have ballot drop boxes. Please <a target="_blank" href="https://www.sos.ms.gov/elections-voting">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['MO'] = 'Missouri does not have ballot drop boxes. Please <a target="_blank" href="https://www.sos.mo.gov/elections">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['NH'] = 'New Hampshire does not have ballot drop boxes. Please <a target="_blank" href="https://www.sos.nh.gov/elections/voters">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['SC'] = 'South Carolina does not have ballot drop boxes. Please <a target="_blank" href="https://scvotes.gov/">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['TN'] = 'Tennessee does not have ballot drop boxes. Please <a target="_blank" href="https://sos.tn.gov/elections">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['TX'] = 'Texas does not have ballot drop boxes. Please <a target="_blank" href="https://www.sos.state.tx.us/elections/">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['WV'] = 'West Virginia does not have ballot drop boxes. Please <a target="_blank" href="https://sos.wv.gov/elections/Pages/default.aspx">visit the Secretary of State website</a> to find information on how to vote.';
            noEarlyVoting['WY'] = 'Wyoming does not have ballot drop boxes. Please <a target="_blank" href="">visit the Secretary of State website</a> to find information on how to vote.';
                                ...
                                if( state_abbrev && lat && lng ){
                                    ...
                                    if( state_abbrev == 'MI'){
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            dataType: "jsonp",
                                            url: "https://www.googleapis.com/civicinfo/v2/voterinfo?key=<?php echo $google_api_key; ?>&electionId=8000",
                                            data: formData,
                                            success: function(data) {
                                                ...
                                                if(data.error){
                                                    ...
                                                    if(ballotTrack[data.state[0].name]){
                                                        ballotTrackCheck = '<p class="ballot-track content-row--bright-green p-4">'+ballotTrack[data.state[0].name]+'</p>'
                                                    }
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                ...
                                                if(data.results.early_voting.length > 0){
                                                    ...
                                                    earlyHtml += '<h5>Your Ballot Dropoff Locations</h5>';
                                                    ...
                                                    */
                                                    ...
                                                    var onlyDropBoxes = onlyDropBoxes.filter(function( obj ) {
                                                    ...
                                                    onlyDropBoxes.forEach(earlyLocationsTable);
