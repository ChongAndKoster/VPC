...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <div id="vote-by-mail">
            <section class="vote-by-mail-banner content-row content-row--bright-green">
                <div class="container">

                    <h1 class="vote-by-mail-banner__headline wow fadeInUp"><?php the_field('page_headline'); ?></h1>

                    <div class="vote-by-mail-banner__text rich-text wow fadeInUp">
                        <?php the_field('page_intro_text'); ?>
                    </div>

                    <form method="get" class="vote-by-mail-banner__form wow fadeInUp" @submit.prevent="search()">
            ...
            <div class="vote-by-mail-states-wrap">
                <transition name="fade" mode="out-in" v-on:enter="enter">
                    <section class="vote-by-mail-states" v-if="! stateSelected" key="voterInfoStates" v-cloak>

                        <?php
                        $home_voter_info_pages = get_pages([
                            'meta_key' => '_wp_page_template',
                            'meta_value' => 'templates/home-voter-info.php',
                        ]);
                        if ($home_voter_info_pages) :
                            $home_voter_info_page = $home_voter_info_pages[0];
                        ?>
                            <div class="vote-by-mail-states__secondary">
                                <div class="secondary__west">
                                    <div class="container">
                                        <?php if ($voter_info_left_block = get_field('voter_info_left_block', $home_voter_info_page->ID)) : ?>
                                ...
                                <div class="secondary__east">
                                    <div class="container">
                                        <?php if ($voter_info_right_block = get_field('voter_info_right_block', $home_voter_info_page->ID)) : ?>
                            ...
                            </div> <!-- .vote-by-mail-states__secondary -->
                        <?php endif; ?>

                        <div class="container">
                            <div class="vote-by-mail-states__primary">
                                <h2 class="primary__headline">Select Your State</h2>
                                ...
                                <div class="primary__states">
                                    ...
                                    <a v-bind:href="'#' + state.abbrev" class="state" v-bind:class="{ 'state--loading': stateIsLoading(state.abbrev) }" v-for="(state, index) in states" @click.prevent="loadAndSetActiveState(state.abbrev)">
                                        ...
                                        </div> .state__info commented out post-election -->

                                        <!-- <div class="state__lower-bar" v-if="stateHasVoteByMail(state)">
                                            Vote by Mail
                                            <span class="lower-bar__icon"></span>
                                        </div> commented out to match live changes made on prod git add -->
                            ...
                            </div> <!-- .vote-by-mail-states__primary -->

                        </div> <!-- .container -->
                    </section> <!-- .vote-by-mail-states -->

                    <section class="vote-by-mail-state-detail" v-else key="voterInfoStateDetail" v-cloak>
                        <div class="container">
                        ...
                        <div class="state-detail__vote-by-mail" v-if="stateHasVoteByMail(activeStateInfo)">
                            <div class="container">
                                ...
                                <div class="d-flex flex-row justify-content-center">
                                    <a class="btn btn--dark-blue mt-3 btn-lg" v-if="activeStateInfo.vote_by_mail.state_vote_by_mail_button_url && activeStateInfo.vote_by_mail.state_vote_by_mail_button_text" v-bind:href="activeStateInfo.vote_by_mail.state_vote_by_mail_button_url" v-bind:target="activeStateInfo.vote_by_mail.state_vote_by_mail_button_url_target">{{ activeStateInfo.vote_by_mail.state_vote_by_mail_button_text }}</a>
                                </div>
                            </div> <!-- .container -->
                        ...
                        <div class="state-detail__info" v-if="activeStateInfo.additional_information">
                            <div class="container">
                                ...
                                <div class="info__blocks">
                                    <div v-for="info in activeStateInfo.additional_information" class="block rich-text">
                    ...
                    </section> <!-- .vote-by-mail-state-detail -->
                </transition>
            </div>
